      ...
      <Container className="relative">
        ...
        <div className="lg:flex justify-between">
          ...
          <motion.div
            ...
            exit="exit"
            viewport={{ once: true, amount: 0.3 }}
            variants={fadeInAnimation({ delay: 0.4, scale: 0.95, x: 30 })}
        ...
        <div className="relative flex flex-col md:flex-row gap-3.5 md:gap-5 w-full">
          ...
          <motion.div
            ...
            variants={fadeInAnimation({ delay: 0.2, scale: 0.95, y: 30 })}
          ...
          <motion.div
            ...
            exit="exit"
            viewport={{ once: true, amount: 0.1 }}
            variants={fadeInAnimation({ delay: 0.4, scale: 0.95, y: 30 })}
          ...
          <motion.div
            ...
            exit="exit"
            viewport={{ once: true, amount: 0.1 }}
            variants={fadeInAnimation({ delay: 0.6, scale: 0.95, y: 30 })}
